...
MARKOV_BASE_MATRIX: np.ndarray = np.array([
    # LAT    EMG    GRW    VIR    DEC
    [0.93,  0.05,  0.02,  0.00,  0.00],  # Латентная
    [0.30,  0.50,  0.15,  0.05,  0.00],  # Зарождение
    [0.10,  0.20,  0.45,  0.15,  0.10],  # Рост
    [0.00,  0.00,  0.12,  0.30,  0.58],  # Вирусная
    [0.20,  0.08,  0.00,  0.02,  0.70],  # Затухание
], dtype=np.float64)
